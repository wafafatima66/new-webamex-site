...
<!--Get started area-->
      ...
      <div class="get-started ">
          <h6 class="text-center">Get started </h6>
            <div class="container">
              <div class="row">

                <div class="col-sm-4 text-center ">
                  <div class="get-started-icon">
                  <i class="fa fa-phone get-icon"></i><br>
...
<!--about area -->
<div class="about-area-home pt-3">
...
<!---JOIN area-->
    ...
    <div class="join-area p-4">
    <div class="container">
      <div class="text-center">
        <h3>Join Our Team</h3>
        <button class= "join-button btn">Join now</button>
      </div>
    </div>
    </div>
...
<div class="portfolio mt-5">
  ...
  <div class="container">
      <div class="row ">
          <div class="col-md-4 col-sm-8 mx-sm-auto mb-sm-3 mb-md-0">
              <div class="card portfolio-card" >
                  <img src="image/31jpg.jpg" class="card-img-top" alt="...">
                  <div class="card-body portfolio-card-body">
                    <h5 class="card-title">Blood Donate App</h5>
          ...
          <div class="col-md-4 col-sm-8 mx-sm-auto mb-sm-3 mb-md-0">
              <div class="card portfolio-card" >
                  ...
                  <div class="card-body portfolio-card-body">
                    <h5 class="card-title">Online News</h5>
                    <a href="#" class="btn">View</a>
                  </div>
                </div>
          </div>
          <div class="col-md-4 col-sm-8 mx-sm-auto mb-sm-3 mb-md-0">
              <div class="card portfolio-card" >
                  ...
                  <div class="card-body portfolio-card-body">
                    <h5 class="card-title">Varsity Club</h5>
                    <a href="#" class="btn ">View</a>
                  </div>
                </div>
          </div>
        ...
        <div class="row mt-5 mb-5">
          <div class="col-md-4 col-sm-8 mx-sm-auto mb-sm-3 mb-md-0">
              <div class="card portfolio-card" >
                  <img src="image/34.jpg" class="card-img-top" alt="...">
                  <div class="card-body portfolio-card-body">
                    <h5 class="card-title">Juran</h5>
                    <a href="#" class="btn ">View</a>
                  </div>
                </div>
          </div>
          <div class="col-md-4 col-sm-8 mx-sm-auto mb-sm-3 mb-md-0">
              <div class="card portfolio-card">
                  <img src="image/35.jpg" class="card-img-top" alt="...">
                  <div class="card-body portfolio-card-body">
          ...
          <div class="col-md-4 col-sm-8 mx-sm-auto mb-sm-3 mb-md-0">
              <div class="card portfolio-card" >
                  <img src="image/36.jpg" class="card-img-top" alt="...">
                  <div class="card-body portfolio-card-body">
                    <h5 class="card-title">Allumni Club</h5>
                    <a href="#" class="btn ">View</a>
                  </div>
                </div>
          </div>
